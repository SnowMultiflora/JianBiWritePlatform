...
<%
   ...
   if(p<0){
   	response.sendRedirect("newsInfoList2.jsp");
   }
   Map resultMap=actionBean.queryNewsByPage2(p,cid,ntitle);
...
<div class="right">
	<div class="admin">
		<h1 class="title">文章审核管理<a href="admin/welcome.jsp" class="back-btn">返回主页</a></h1>
	
		<table class="tab" cellspacing="0">
		<tr>
		  <td colspan="5">
		  <form action="admin/newsInfoList2.jsp" method="post" id="frm">
		    <label>文章类别：</label>
		    <select name="cid">
		 ...
		 <a class="btn" href="javascript:void(0)" onclick="updateNews()">审核</a>
		...
		//发起ajax请求进行用户的修改
				...
				if("power"==data){
				  alert("权限不足");
					...
					location="admin/updateNews2.jsp?nid="+obj.value;
					}
