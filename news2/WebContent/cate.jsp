...
<%
   ...
   Map resultMap=actionBean.queryNewsByPage3(p,cid,ntitle,aid);
...
<div class="right">
	<div class="admin">
		<h1 class="title">已审核文章</h1>
	
		<table class="tab" cellspacing="0">
		<tr>
		  <td colspan="5">
		   <form action="cate.jsp" method="post" id="frm">
		    <label>文章类别：</label>
		    <select name="cid">
		...
		//发起ajax请求进行用户的删除
				...
				if("power"==data){
				  alert("权限不足");
						...
						alert("文章删除成功");
						window.location.href = "DeleteNewsServlet4?nid="+obj.value;
					}
