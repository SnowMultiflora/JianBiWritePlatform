...
<%
  ...
  String aid=(String)session.getAttribute("aid");
   ...
   Map resultMap=actionBean.queryNewsByPage4(p,cid,ntitle,aid);
...
<div class="right">
	<div class="admin">
		<h1 class="title">被退回文章</h1>
	
		<table class="tab" cellspacing="0">
		<tr>
		  <td colspan="5">
		   <form action="cate1.jsp" method="post" id="frm">
		    <label>文章类别：</label>
		    <select name="cid">
		...
		//发起ajax请求进行用户的修改
				...
				if("power"==data){
				  alert("权限不足");
					...
					location="updateNews2.jsp?nid="+obj.value;
					}
		...
		//发起ajax请求进行用户的删除
				...
				if("power"==data){
				  alert("权限不足");
						...
						alert("文章删除成功");
						window.location.href = "DeleteNewsServlet3?nid="+obj.value;
					}
