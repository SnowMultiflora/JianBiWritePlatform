	 ...
	 var ipts = [ "ntitle", "cid", "ndate"];
		...
		//发起ajax请求进行用户的修改
				...
				if("true"==data){
					eval(data);
						alert("文章修改成功");
						window.location.href = "/news2/cate1.jsp";
					}else if("false"==data){
					eval(data);
					alert("文章修改失败");
	 ...
	 var ipts = [ "ntitle", "cid", "ndate"];
		...
		//发起ajax请求进行用户的修改
				...
				if("true"==data){
					eval(data);
						alert("投稿成功，等待审核");
						window.location.href = "/news2/add.jsp";
					}else if("false"==data){
					eval(data);
					alert("投稿失败");
...
<body>
					...
					<table>
						...
						<tr>
							...
							<td><a class="btn" onclick="insert();"
								...
								<td><a style="position: absolute;left: 240px;top: 629px;" class="btn" onclick="insert2();"
								href="javascript:void(0)">投稿</a></td>
	...
	<div style="height: 300px; position: absolute;left:200px;">
	<span style="position: relative;left: 220px;">审核意见：</span>
	   <div style=" width:500px; height:100px; border: solid;border-width:1px 1px 1px 1px;       border-color: black;">
	   <%=news.getTex() %>
	   </div>
	</div>
