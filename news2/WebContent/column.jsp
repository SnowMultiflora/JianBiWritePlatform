	  ...
	  var ipts = [ "ntitle", "cid", "ndate"];
		...
		//发起ajax请求进行用户的修改
				...
				if("true"==data){
					eval(data);
						alert("文章增加成功");
						window.location.href = "cate2.jsp";
					}else if("false"==data){
					eval(data);
					alert("文章增加失败");
						window.location.href = "column.jsp";
					} else{
					eval(data);
					alert("不能为空");
					...
					<table>
						...
						<tr>
							...
							<td><input id="author" readonly="readonly" name="author" autocomplete="off"
								maxlength="50" type="text" value="<%=session.getAttribute("aname") %>" /></td>
							<td id="err-ntitle"></td>
						</tr>
						<tr>
							<td>指导老师：</td>
						...
						<tr>
							...
							<td><a class="btn" onclick="insert();"
								href="javascript:void(0)">保存为草稿</a></td>
								<td style="position: absolute;left: 250px;top: 629px;"><a   class="btn" onclick="insert2();"
